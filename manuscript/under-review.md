...
language. We will also discover *type classes* as a way to achieve
...
-   may extend other type classes

Type classes are used in the Scala standard library to encode numbers.
This is a simplified `Numeric` to demonstrate the principle:
...
number types, prefer [spire](https://github.com/non/spire) to the standard library.

### TODO implicit resolution rules

### TODO circe / scalacheck-shapeless

### TODO cachedImplicit into a val

### TODO downside is compile time speeds for ADTs of 50+

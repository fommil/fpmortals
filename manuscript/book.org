...
Cats is a 3 year old experiment to rewrite scalaz. Cats is a member of
the [[http://typelevel.org/about.html][Typelevel]] sociopolitical project, which has moderators who enforce
a Code of Conduct to ensure that their spaces are welcoming and
inclusive.

Although this book uses scalaz, a second book will be available - at a
discount to those who buy this book - covering the cats library.
#+END_ASIDE

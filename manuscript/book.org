...
#+BEGIN_ASIDE
Cats is an evolving technical experiment under the Typelevel social
project which has moderators on their channels who enforce a Code of
Conduct. Cats has origins in the decade-long =scalaz= technical
project.

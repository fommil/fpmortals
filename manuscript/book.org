...
[[http://typelevel.org/about.html][Typelevel]] community, organised around functional programming in Scala.
Typelevel is a political organisation who enforce a Code of Conduct to
ensure that their spaces are welcoming, inclusive and safe.

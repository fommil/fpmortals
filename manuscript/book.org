...
Futures, how to unsuck them]], Noel Markham for [[https://www.47deg.com/presentations/2017/06/01/ADT-for-the-win/][ADTs for the Win!]]
...
To remain safe, [[https://github.com/wartremover/wartremover/issues/382][guards should not be used when matching on a =sealed=
type]].
...
class=, so there is no real reason for =sealed trait=.
#+END_ASIDE

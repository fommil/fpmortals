...
[[http://underscore.io/books/advanced-scala/][Advanced Scala with Cats]] by Underscore Consultants. At this point,
cats is mostly a clone of scalaz, so this book is relevant for either
library.
#+END_ASIDE
...
#+BEGIN_SRC dot :file images/scalaz-combinable.png :exports results
digraph G {
    Semigroup
    Monoid -> Semigroup
    Band -> Semigroup
...
#+RESULTS:
[[file:images/scalaz-combinable.png]]

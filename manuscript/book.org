...
# type FS[A] = FreeS.Par[F, A] // applicative, where F is synthetic and added by the macro
# type FreeS.Par[F, A] = FreeApplicative[F, A]
# type FreeS[F, A] = Free[FreeApplicative[F, ?], A] //monad

*** TODO Free Monad

# high level of what @free is doing, trampolining

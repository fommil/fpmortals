...
temptation of less typing. It is a [[https://github.com/scala/bug/issues/10411][quirk of implicit resolution]] that
...
#+BEGIN_INFO
In these payload examples, ={CAPITAL_SYMBOLS}= are used as
placeholders for variables, and escaped newlines have been added for
clarity.
#+END_INFO
...
that will exception when parsed or hang the =Thread= forever if

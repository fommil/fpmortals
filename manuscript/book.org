...
#+BEGIN_ASIDE
This provides the /type constructor/, which looks like =C[_]=, a way
of saying that whatever goes here must take a type parameter but we
don't care what that parameter is.
#+END_ASIDE
